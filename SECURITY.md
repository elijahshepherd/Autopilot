...
Autopilot is a fork of [microsoft/vscode](https://github.com/microsoft/vscode). For security issues affecting the core VS Code codebase that also affect Autopilot, you may also report upstream.

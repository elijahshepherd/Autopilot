...
export class GrowthSessionController extends Disposable implements IChatSessionItemController {
	...
	get items(): readonly IChatSessionItem[] {
		...
		return [{
			...
			label: localize('growthSession.label', "Try Autopilot AI"),
			description: localize('growthSession.description', "Autopilot AI is available. Try it for free."),
